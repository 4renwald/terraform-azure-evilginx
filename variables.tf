...
variable "cloudflare_api_token" {
  description = "Backward-compatibility input for callers that previously threaded Cloudflare provider authentication through the module. Prefer configuring the Cloudflare provider directly in the caller root module."
  type        = string
  sensitive   = true
  default     = null
  nullable    = true
