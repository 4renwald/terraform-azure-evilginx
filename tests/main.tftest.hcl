...
variables {
  ...
  evilginx_additional_subdomains          = ["app", "portal"]
...
run "validate_plan" {
  ...
  assert {
    condition     = cloudflare_record.evilginx_additional_fqdns["app.test-phishing.example.com"].name == "app.test-phishing.example.com"
    error_message = "Additional Evilginx Cloudflare record should exist for app.test-phishing.example.com."
  }

  assert {
    condition     = cloudflare_record.evilginx_additional_fqdns["portal.test-phishing.example.com"].name == "portal.test-phishing.example.com"
    error_message = "Additional Evilginx Cloudflare record should exist for portal.test-phishing.example.com."
  }
