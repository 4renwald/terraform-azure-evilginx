...
resource "azurerm_linux_virtual_machine" "evilginx" {
  ...
  source_image_reference {
    publisher = local.ubuntu_image_reference.publisher
    offer     = local.ubuntu_image_reference.offer
    sku       = local.ubuntu_image_reference.sku
    version   = local.ubuntu_image_reference.version
  }
}
